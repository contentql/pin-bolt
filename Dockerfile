...
COPY --from=builder --chown=nextjs:nodejs /app/src/scripts/run-migrations.ts ./run-migrations.ts
...
CMD HOSTNAME="0.0.0.0" pnpx tsx ./run-migrations.ts && node server.js
